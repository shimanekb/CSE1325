...
void prdouble_if_equal(double, int);
void prdouble_if_not_equal(double, int);
...
int main()
{
    ...
    while (true)
    {
        ...
        prdouble_if_equal(number1, number2);
        prdouble_if_not_equal(number1, number2);
...
void prdouble_if_not_equal(double number1, int number2)
{
        if (number1 != number2)
         {
...
void prdouble_if_equal(double number1, int number2)
{
        if (number1 == number2)
